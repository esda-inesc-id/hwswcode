...
RUN_DEPS+=iob_axil_macc_tester_bootrom.hex iob_axil_macc_tester_firmware.hex
...
BUILD_DEPS+=iob_axil_macc_tester_bootrom.hex $(if $(filter $(INIT_MEM),1),iob_axil_macc_tester_firmware.hex)

QUARTUS_SEED ?=5
SDC_PREFIX=iob_axil_macc_tester
