...
\
  ...
  # Create instance: axil_macc_0, and set properties
  set axil_macc_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:axil_macc:1.0 axil_macc_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins axil_macc_0/s_axi_BUS1]
  ...
  [get_bd_pins axil_macc_0/ap_clk] \
  ...
  [get_bd_pins axil_macc_0/ap_rst_n] \
  [get_bd_pins axi_smc/aresetn]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axil_macc_0/s_axi_BUS1/Reg] -force
